        ...
        <div>
            ...
            <div className="max-w-8xl mx-auto px-8 pt-10 flex font-abz mb-12">
                <div className="min-w-[50%]">
                    <p className="text-[32px] font-semibold font-raleway leading-none">{entry?.product_name ? entry?.product_name : product?.title?.en}</p>
                ...
                <div className="  border-l h-page px-5">
                    <div className="flex">
                        <p className="text-[32px]">{entry?.price ? entry?.price : product?.price}</p>
                    </div>

                    <div
                        className="mt-10 font-light  [&_ul]:list-disc font-roboto"
